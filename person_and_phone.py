...
def weights_download(out='C:/Users/User/Desktop/main project/SE/spApp/models/yolov3.weights'):
    _ = wget.download(
        'https://pjreddie.com/media/files/yolov3.weights', out='C:/Users/User/Desktop/main project/SE/spApp/models/yolov3.weights')
...
def main(vid):
    ...
    load_darknet_weights(
        yolo, 'C:/Users/User/Desktop/main project/SE/spApp/models/yolov3.weights')
    ...
    while (True):
        ...
        img = img / 255
        class_names = [c.strip()
                       for c in open("C:/Users/User/Desktop/main project/SE/spApp/models/classes.TXT").readlines()]
    ...
    if mpFlag and pFlag:
        res = "More than 1 person and Mobile phone detected"
    elif mpFlag:
        res = "More than 1 person"
    elif pFlag:
        res = "Mobile phone detected"
    else:
        res = 'None'
